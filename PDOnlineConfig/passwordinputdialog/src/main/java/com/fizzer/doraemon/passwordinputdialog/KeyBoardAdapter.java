...
public class KeyBoardAdapter extends BaseAdapter {
    ...
    public KeyBoardAdapter(Context mContext, String[] num) {
        height = Utils.getOutMetrics(mContext).heightPixels/16.0f;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ViewGroup.LayoutParams lp = new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, (int) height);
