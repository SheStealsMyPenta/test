...
public class CubicleTestActivity extends AppCompatActivity implements NetListener {
...
//                    break;
                case R.id.hf:
                    ...
                    intentHf.setClass(CubicleTestActivity.this, CubicleTestHFActivity.class);
                ...
                case R.id.ae:
                    ...
                    intent.setClass(CubicleTestActivity.this, CubicleTestAEActicity.class);
                    startActivity(intent);
                    break;
                case R.id.tev:
                    Intent intentTev = new Intent();
                    intentTev.setClass(CubicleTestActivity.this, CubicleTestTEVActivity.class);
    ...
    private void addListener() {
        ...
        backToListLaout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(CubicleTestActivity.this, MonitorDeviceManageActivity.class);
...
//            intent.putExtra("fromTest", true);
        ...
        btn_4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (btn_4.getText().toString().equals("配置")) {
                    ...
                    //保存
                    boolean success = uhfConfig.sendData();
                    if (!success) {
        ...
        data.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                isFetchingData = true;
                service.getDataByType(netHandler, type);
    ...
    private void setupWithViewPager() {
        ...
        uhfConfig = UHFConfigFragment.newInstance(netHandler, "开关柜", "uhf");
...
//                    CacheData.currentUHFParams = uhfFragment.getData();
            ...
            case Command.CHECK_SETUHFPARAMS_OVERTIME:
                ...
                if (uhfConfig.setting) {
                    //超时
                    if (mViewPager.getCurrentItem() == 1) {
                        Toast.makeText(this, "设置特高频参数超时", Toast.LENGTH_LONG).show();
                    }
                    uhfConfig.cancelSwipeLoading();
                    uhfConfig.setting = false;
                }
